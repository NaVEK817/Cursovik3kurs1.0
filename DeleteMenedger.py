# Form implementation generated from reading ui file 'delete_menedger_ui.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Удаление менеджера"))
        self.pushButton.setText(_translate("Form", "Удалить"))
        self.label.setText(_translate("Form", "Введите id менеджера"))
